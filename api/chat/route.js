...
Studio Info:
- Packages: Starter (₹3,999), Business (₹9,999 - Most Popular), Custom Growth (₹15,999).
  ...
  try {
    ...
    if (geminiKey) {
      try {
        ...
        console.warn(
          "Gemini call skipped, evaluating guardrails locally:",
          err.message,
        );
      }
    }
    ...
    if (openaiKey) {
      try {
        ...
        console.warn(
          "OpenAI call skipped, evaluating guardrails locally:",
          err.message,
        );
      }
    }
    ...
    return NextResponse.json(
      {
        reply:
          "I can only assist with Sharvonix web development and design inquiries. Would you like to discuss a project for your brand? You can connect directly on WhatsApp at +91 79882 07356.",
      },
      { status: 500 },
    );
  }
